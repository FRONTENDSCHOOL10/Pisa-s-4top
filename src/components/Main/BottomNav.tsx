...
export default function BottomNav() {
   ...
   return (
      <nav
         aria-label="하단 내비게이션"
         className="fixed bottom-0 flex h-[3.75rem] w-full max-w-[48rem] items-center justify-around border-t-[1px] bg-stone-50 text-xl bg-blend-multiply [box-shadow:0px_-10px_30px_0px_var(--tailwind-stone-stone-300,_#D6D3D1),_0px_0px_30px_0px_var(--tailwind-white-white,_#FFF)_inset]"
      >
